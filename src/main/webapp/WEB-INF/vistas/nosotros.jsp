													...
													<div class="row">
														<div class="col-md-7">
															<div class="form-group" >
																<h3 class="card-title">
																	<strong>La Veterinaria ZOOTOPÍA es una empresa dedicada al cuidado de las mascotas, que lleva en el mercado desde el año 2021, trabajando en el bienestar de cada mascota. Desde entonces, sus primordiales objetivos estuvieron encaminados a mejorar en todos sus servicios, y muchos de estos objetivos se han logrado, dando como resultado el poder ofrecer a todos nuestros clientes un servicio integral atendidos por profesionales de altísima calidad, todo ésto con el fin de tratar nuestros pacientes como seres que merecen la mejor atención y especial cuidado.</strong>
																</h3>
															</div>
														</div>
														<div class="col-md-5" >
						...
						<div class="card-body" style="padding: 20px 10px;">
													<div class="row">
														<div class="col-md-6">
															<div class="form-group" >
																<h3 class="card-title">
																	<strong>La veterinaria ZOOTOPÍA tiene como visión ser una  de las veterinarias líderes en prestación de servicios médicos veterinarios de la mejor calidad y profesionalismo, con énfasis en animales de compañía. Nuestro compromiso social es mejorar la calidad de vida de las familias a través del cuidado de la salud de nuestros pacientes contando con excelente tecnología, un equipo médico altamente calificado con educación y capacidad continua.</strong>
																</h3>
															</div>
														</div>
														<div class="col-md-6">
